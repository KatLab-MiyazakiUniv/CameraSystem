...
def test_get_direction_route(block_bingo):
    assert block_bingo.get_direction_route([0, 1, 2, 6, 10, 11, 15]) == ['right', 'right', 'down', 'down', 'right', 'down']


def test_get_num_route(block_bingo):
    assert block_bingo.get_num_route(['right', 'right', 'down', 'down', 'right', 'down'], 0) == [0, 1, 2, 6, 10, 11, 15]
