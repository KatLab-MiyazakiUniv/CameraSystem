...
def test_calcPoints():
    ...
    cc_points = get_circle_point.calcPoints(points, 16)
...
def test_add():
    ...
    get_circle_point.cc_points = get_circle_point.calcPoints(cc_points, 16)
    get_circle_point.bc_points = get_circle_point.calcPoints(bc_points, 8)
